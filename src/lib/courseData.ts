  ...
  blocks: [
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'e1-3', type: 'fill_blank', prompt: 'Ik ___ in Amsterdam. (vivir)', correctAnswer: 'woon', hint: 'Ik + verbo conjugado' },
        { id: 'e1-4', type: 'fill_blank', prompt: 'Ik ___ een beetje Nederlands. (hablar)', correctAnswer: 'spreek', hint: '"Spreken" → ik spreek' },
        ...
        { id: 'e1-7', type: 'fill_blank', prompt: 'Ik ___ als verpleegkundige. (trabajar)', correctAnswer: 'werk', hint: '"Werken" → ik werk' },
...
const m1_les3: Lesson = {
  ...
  blocks: [
    ...
    },
    {
      type: 'practice',
      exercises: [
        { id: 'e3-1', type: 'fill_blank', prompt: 'Ik ___ student. (ser)', correctAnswer: 'ben', hint: '"Zijn" → ik ben' },
        { id: 'e3-2', type: 'fill_blank', prompt: 'Zij ___ elke dag naar haar werk. (ir)', correctAnswer: 'gaat', hint: '"Gaan" → hij/zij gaat' },
        ...
        { id: 'e3-5', type: 'fill_blank', prompt: 'Hij ___ bij een groot bedrijf. (trabajar)', correctAnswer: 'werkt', hint: '"Werken" → hij/zij werkt' },
        ...
        { id: 'e3-7', type: 'fill_blank', prompt: 'Wij ___ samen naar de markt. (ir)', correctAnswer: 'gaan', hint: '"Gaan" → wij gaan' },
  ...
  blocks: [
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'e5-4', type: 'fill_blank', prompt: '"Hoe ___ je dat?" (¿Cómo se escribe eso?)', correctAnswer: 'spel', hint: '"Spellen" → jij spelt / hoe spel je' },
  ...
  blocks: [
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'erou-2', type: 'fill_blank', prompt: 'Ik ___ om zeven uur op. (levantarse)', correctAnswer: 'sta', hint: '"Opstaan" es separable: ik sta op' },
        ...
        { id: 'erou-5', type: 'fill_blank', prompt: 'Ik ___ drie keer per week. (hacer deporte)', correctAnswer: 'sport', hint: '"Sporten" → ik sport' },
      ],
    },
    { type: 'review' },
  ],
