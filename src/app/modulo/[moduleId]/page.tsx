      ...
      {lessons.map(lesson => {
        ...
        return (
          <Link
            ...
            className={`group flex items-start gap-4 rounded-2xl border p-5 transition-all duration-300 hover:shadow-[0_8px_32px_rgba(29,0,132,0.08)] ${
              isNext
              ...
              <div className="flex items-start justify-between gap-2 mb-1.5">
                <h3
                  className={`text-[15px] font-bold leading-snug ${
                    isNext ? 'text-[#1D0084]' : 'text-[#1D0084]'
